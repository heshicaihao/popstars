package com.heshicaihao.constant;
...
public class ConstantUtil {
	...
	public final static int PINK=4;//粉色
	public final static int GAME_START=1;//游戏开始
	public final static int GAME_NEXT=2;//游戏开始
	public final static int GAME_ING=3;//游戏进行中
	public final static int GAME_END=4;//游戏结束
	public final static int GAME_WAIT=5;//等待用户输入
	public static int TO_MAIN_VIEW = 7;
	public static int END_GAME = 8;
	public static int RESUME_GAME = 9;
	public static int START_GAME = 10;
	public static int BLOCK_BOMB_GAME = 11;
	public static int UPDATE_SHOW_SCORE = 12;
	public static int UPDATE_NEXT = 13;
	public static int UPDATE_FIREWORK = 14;
	public static int UPDATE_BOMB = 15;
